...
<head>
    ...
    <!-- Custom CSS -->
    <link href="../resources/assets/css/login_stylish.css" rel="stylesheet">

    <!-- Custom Fonts -->
    <link href="../resources/assets/css/font-awesome.min.css" rel="stylesheet" type="text/css">
    <link href="../resources/image/logo.ico" rel="icon">
            ...
            <div class="row">
                <div class="col-lg-10 col-lg-offset-1 text-center">
                    ...
                    <ul class="list-inline">
                        <li>
                            <a href="https://www.facebook.com/guyub.haq" target="blank"><i class="fa fa-facebook fa-fw fa-3x"></i></a>
                        </li>
                        <li>
                            <a href="https://www.instagram.com/gasbatik/" target="blank"><i class="fa fa-instagram fa-fw fa-3x"></i></a>
                        </li>
                    </ul>
                    <hr class="small">
      ...
      <div class="modal-body">
        <form class="form-horizontal" role="form" method="POST" action="{{ url('/login') }}" id="form-login">
          ...
          <div class="form-group">
            ...
            <input id="email" name="email" type="email" placeholder="Email" value="{{ old('email') }}" class="form-control"/>
          </div>
          <div class="form-group">
