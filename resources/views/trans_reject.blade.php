...
@section('css')
	<link href="{{ getenv('APP_URL') }}/resources/assets/css/plugins/select2/select2.css" rel="stylesheet">
	<link href="{{ getenv('APP_URL') }}/resources/assets/css/plugins/datepicker/bootstrap-datepicker.css" rel="stylesheet">
@endsection

@section('content')
		<h1 class="page-title">Input Reject</h1>
		<!-- Breadcrumb -->
...
@section('script')
	<script src="{{ getenv('APP_URL') }}/resources/assets/js/plugins/select2/select2.full.min.js"></script>
	<script src="{{ getenv('APP_URL') }}/resources/assets/js/plugins/datepicker/bootstrap-datepicker.js"></script>
	<script src="{{ getenv('APP_URL') }}/resources/assets/js/app/trans_reject.js"></script>
@endsection